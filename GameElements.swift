...
extension GameScene{
    func createBird() -> SKSpriteNode {
        let bird = SKSpriteNode(texture: SKTextureAtlas(named:"player").textureNamed("flower"))
   bird.texture = SKTexture(imageNamed: "nin1")
    ...
    func createWalls() -> SKNode  {
        ...
        let flowerNode = SKSpriteNode(imageNamed: "water")
        flowerNode.size = CGSize(width: 60, height: 60 )
